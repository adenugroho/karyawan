...
<script> window.setTimeout(function() { $(".alert-success").fadeTo(500, 0).slideUp(500, function(){ $(this).remove(); }); }, 3000); 
window.setTimeout(function() { $(".alert-danger").fadeTo(500, 0).slideUp(500, function(){ $(this).remove(); }); }, 3000);</script>
 <script>
function sum() {
      var gapok = document.getElementById('gapok').value;
      var ketidakhadiran = document.getElementById('ketidakhadiran').value;
       var lembur = document.getElementById('lembur').value;
        var jml_lembur = document.getElementById('jml_lembur').value;
         var bonus = document.getElementById('bonus').value;
         var tunjangan = document.getElementById('tunjangan').value;
      var potongan =  parseInt(gapok) * (2/100);
      var jumlah= (parseInt(ketidakhadiran) * parseInt(potongan));
       var gaji= (parseInt(gapok) - parseInt(jumlah));
       var jumlah_lembur = (parseInt(lembur) * parseInt(jml_lembur));
       var TOTAL = (parseInt(gaji) + parseInt(jumlah_lembur) + parseInt(bonus)+ parseInt(tunjangan));


       
      if (!isNaN(jumlah)) {
         document.getElementById('potongan').value = jumlah;
      }
       if (!isNaN(TOTAL)) {
