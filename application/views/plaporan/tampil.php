   ...
   <br>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form  action="<?php echo site_url('PLaporan/search_keyword');?>" method = "post"  class="form-horizontal" >
...
?>
 ...
 if(isset($_POST['submit'])){
   ...
   $romawi = getBulan($bln);
    ...
    <h2 align="center">Laporan Gaji Divisi <?php echo $divisi; ?> Bulan <?php echo $romawi; ?> Tahun <?php echo $tahun; ?></h2>
</hr>
</br>
</br>
...
<td bgcolor="yellow"><b>Rp. <?php echo number_format( $total->hasil,2,',','.'); ?></b></td>
</table>
