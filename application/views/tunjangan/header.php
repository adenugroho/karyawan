...
<head>
 ...
 <script type="text/javascript">
    ...
    <script>
function sum() {
      var txtFirstNumberValue = document.getElementById('val1').value;
      var txtSecondNumberValue = document.getElementById('val2').value;
      var result = 12 - (parseInt(txtFirstNumberValue) + parseInt(txtSecondNumberValue));
       var result1 = (parseInt(txtFirstNumberValue) + parseInt(txtSecondNumberValue));
      if (!isNaN(result)) {
         document.getElementById('val3').value = result;
      }
       if (!isNaN(result1)) {
         document.getElementById('val4').value = result1      ;
      }
}
</script>
<script>   
